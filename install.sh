...
echo "[1/13] Backing up existing Hyprland configs..."
...
echo "[5/13] Enabling SDDM display manager..."
sudo systemctl enable sddm --now

# 6. Install swww wallpaper daemon
echo "[6/13] Installing swww from source..."
...
echo "[7/13] Installing Hyprpaper..."
...
echo "[10/13] Installing Nerd Fonts..."
sudo dnf copr enable -y rmihaylov/nerd-fonts
sudo dnf install -y nerd-fonts-complete

# 11. Icon & GTK themes
echo "[11/13] Installing Tela Circle Dracula and Catppuccin themes..."
# Tela Circle Dracula
...
echo "[12/13] Configuring Thunar as default file manager..."
...
# 13. Cleanup
echo "[13/13] Cleaning up temporary build folders..."
